...
public class TestJSONStreamMarshaller_ParametrizedCollectionFields {
	...
	public void test_jsonobjectmapper_array_tojson() {
		...
		try {
			...
			obj.obj_arr.get( 0 ).b2_arr = arrayToArrayList( new Boolean[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).i2_arr = arrayToArrayList( new Integer[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).l2_arr = arrayToArrayList( new Long[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).f2_arr = arrayToArrayList( new Float[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).d2_arr = arrayToArrayList( new Double[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).bi_arr = arrayToArrayList( new BigInteger[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).bd_arr = arrayToArrayList( new BigDecimal[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).s_arr = arrayToArrayList( new String[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );

			obj = getTestJSONMapObjectArraysObjectMold();
			obj.obj_arr.get( 0 ).obj_arr = arrayToArrayList( new TestJSONMapObjectArrays[ 1 ] );
			assert_tojson_exception( streamMarshaller, obj, json_encoder, out );
		}
	...
	public TestJSONMapObjectArrays getTestJSONMapObjectArraysObjectMold() {
		...
		obj.b2_arr = arrayToArrayList( new Boolean[] { false, true } );
		obj.i2_arr = arrayToArrayList( new Integer[] { 1234, 4321 } );
		obj.l2_arr = arrayToArrayList( new Long[] { 43210987654321L, 43210987654321L * 2L } );
		obj.f2_arr = arrayToArrayList( new Float[] { 3.0F, 5.0F } );
		obj.d2_arr = arrayToArrayList( new Double[] { 3.0, 5.0 } );
		obj.bi_arr = arrayToArrayList( new BigInteger[] { new BigInteger( "123456789012345678901234567890123456789012" ), new BigInteger( "123456789012345678901234567890123456789012" ).multiply( new BigInteger( "2" ) ) } );
		obj.bd_arr = arrayToArrayList( new BigDecimal[] { new BigDecimal( "3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825" ), new BigDecimal( "3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825" ).multiply( new BigDecimal( "2" ) ) } );
		obj.s_arr = arrayToArrayList( new String[] { "json", "JSON" } );
		//obj.b = "bytes".getBytes();
		TestJSONMapObjectArrays obj2 = new TestJSONMapObjectArrays();
		obj.obj_arr = arrayToArrayList( new TestJSONMapObjectArrays[] { obj2 } );
		obj2.b2_arr = arrayToArrayList( new Boolean[] {} );
		obj2.i2_arr = arrayToArrayList( new Integer[] {} );
		obj2.l2_arr = arrayToArrayList( new Long[] {} );
		obj2.f2_arr = arrayToArrayList( new Float[] {} );
		obj2.d2_arr = arrayToArrayList( new Double[] {} );
		obj2.bi_arr = arrayToArrayList( new BigInteger[] {} );
		obj2.bd_arr = arrayToArrayList( new BigDecimal[] {} );
		obj2.s_arr = arrayToArrayList( new String[] {} );
		//obj2.b = "BYTES".getBytes();
		obj2.obj_arr = arrayToArrayList( new TestJSONMapObjectArrays[] { new TestJSONMapObjectArrays() } );
		return obj;
	}
	...
	public void assert_jsonobjectmapper_array_result(TestJSONMapObjectArrays result) {
		ArrayList<Boolean> b2_arr = arrayToArrayList( new Boolean[] { false, true } );
		ArrayList<Integer> i2_arr = arrayToArrayList( new Integer[] { 1234, 4321 } );
		ArrayList<Long> l2_arr = arrayToArrayList( new Long[] { 43210987654321L, 43210987654321L * 2L } );
		ArrayList<Float> f2_arr = arrayToArrayList( new Float[] { 3.0F, 5.0F } );
		ArrayList<Double> d2_arr = arrayToArrayList( new Double[] { 3.0, 5.0 } );
		ArrayList<BigInteger> bi_arr = arrayToArrayList( new BigInteger[] { new BigInteger( "123456789012345678901234567890123456789012" ), new BigInteger( "123456789012345678901234567890123456789012" ).multiply( new BigInteger( "2" ) ) } );
		ArrayList<BigDecimal> bd_arr = arrayToArrayList( new BigDecimal[] { new BigDecimal( "3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825" ), new BigDecimal( "3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825" ).multiply( new BigDecimal( "2" ) ) } );
		ArrayList<String> s_arr = arrayToArrayList( new String[] { "json", "JSON" } );

		Assert.assertNotNull( result );
		assertListEquals( b2_arr, result.b2_arr );
		assertListEquals( i2_arr, result.i2_arr );
		assertListEquals( l2_arr, result.l2_arr );
		assertListEquals( f2_arr, result.f2_arr );
		assertListEquals( d2_arr, result.d2_arr );
		assertListEquals( bi_arr, result.bi_arr );
		assertListEquals( bd_arr, result.bd_arr );
		assertListEquals( s_arr, result.s_arr );

		b2_arr = arrayToArrayList( new Boolean[] {} );
		i2_arr = arrayToArrayList( new Integer[] {} );
		l2_arr = arrayToArrayList( new Long[] {} );
		f2_arr = arrayToArrayList( new Float[] {} );
		d2_arr = arrayToArrayList( new Double[] {} );
		bi_arr = arrayToArrayList( new BigInteger[] {} );
		bd_arr = arrayToArrayList( new BigDecimal[] {} );
		s_arr = arrayToArrayList( new String[] {} );
