...
public class TestJSONStreamMarshaller_Nullable {
	...
	public void test_jsonobjectmapper_toobject_nullable() {
		...
		try {
			...
			TestJSONMapObjectNullable result = json_objectmappings.getStreamUnmarshaller().toObject( in, json_decoder, TestJSONMapObjectNullable.class );
			...
			in = new ByteArrayInputStream( out.toByteArray() );
			TestJSONMapObject result2 = json_objectmappings.getStreamUnmarshaller().toObject( in, json_decoder, TestJSONMapObject.class );
	...
	public void test_jsonobjectmapper_toobject_nullable_annotation_value() {
		...
		try {
			...
			in = new ByteArrayInputStream( out.toByteArray() );
			TestJSONMapObjectNullableWithAV result = json_objectmappings.getStreamUnmarshaller().toObject( in, json_decoder, TestJSONMapObjectNullableWithAV.class );
			...
			in = new ByteArrayInputStream( out.toByteArray() );
			TestJSONMapObjectWithAV result2 = json_objectmappings.getStreamUnmarshaller().toObject( in, json_decoder, TestJSONMapObjectWithAV.class );
	...
	public void test_jsonboejctmapper_toobject_nullable_invalid() {
		...
		try {
			...
			moldObject.b1 = null;
			assert_toObject_exception( moldObject, out, json_encoder, json_decoder, json_objectmappings );
			...
			for ( int i=0; i<fields.length; ++i ) {
				try {
					...
					//System.out.println( new String( out.toByteArray() ) );
					in = new ByteArrayInputStream( out.toByteArray() );
					json_objectmappings.getStreamUnmarshaller().toObject( in, json_decoder, TestJSONMapObject.class );
	...
	public void test_jsonobjectmapper_tojson_nullable_invalid() {
		...
		try {
			...
			moldObject.b2 = null;
			assert_toJSON_exception( json_objectmappings, moldObject, json_encoder, out );
			...
			assert_toJSONWithAV_exception( json_objectmappings, moldObjectWithAV, json_encoder, out );
